...
const translations = {
  en: {
    ...
    sub_webHeadline: "Subscribe in the mobile app",
    sub_webSubtext: "Download the ChekkiAI app to start your subscription.",
    sub_webCta: "View Download Options →",
    sub_platformApple: "Subscribed via Apple",
    sub_platformGoogle: "Subscribed via Google",
  ...
  ko: {
    ...
    sub_androidSoon: "Android 구독은 곳 출시됩니다",
    ...
    sub_platformApple: "Apple로 구독함",
    sub_platformGoogle: "Google로 구독함",
