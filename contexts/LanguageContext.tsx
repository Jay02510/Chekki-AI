...
const translations = {
  en: {
    ...
    sub_trial_headline: "Try ChekkiAI Free for 7 Days",
    sub_trial_subtext: "Full premium access. Cancel anytime before your trial ends and pay nothing.",
    ...
    sub_disclosure_trial: "After your 7-day free trial, payment will be charged to your Apple ID account. Subscription automatically renews unless cancelled at least 24 hours before the end of the current period. You can manage and cancel your subscription in your App Store account settings.",
    ...
    sub_androidSoonDesc: "Thank you for your patience while we set up Android billing. Please use the iOS app to subscribe.",
    sub_terms: "Subscription is charged to your iTunes account at confirmation of purchase. Subscription automatically renews unless auto-renew is turned off at least 24-hours before the end of the current period.",
    ...
    review_empty_desc: "No items saved for review. Tap ⭐ on any answer to save it here.",
    ...
    bene_tutor: "Interactive AI Tutor",
    ...
    subs_errorMessage: "Payment couldn't be processed. Try a different card or check your payment details.",
  ...
  ko: {
    ...
    guest_used_desc: "무료로 가입하면 하루 3회 스캔과 티칭 스크립트, 발음 듣기 기능을 이용할 수 있어요.",
    ...
    sub_trial_headline: "7일 무료로 ChekkiAI 체험하기",
    sub_trial_subtext: "프리미엄 전체 기능 이용. 체험 기간 종료 전 언제든지 취소하면 요금이 청구되지 않습니다.",
    ...
    sub_disclosure_trial: "7일 무료 체험 후 Apple ID 계정으로 결제됩니다. 현재 구독 기간 종료 최소 24시간 전에 취소하지 않으면 자동으로 갱신됩니다. App Store 계정 설정에서 구독을 관리하고 취소할 수 있습니다.",
    sub_success: "구독 완료!",
    ...
    sub_terms: "구독은 iTunes 계정으로 청구되며, 현재 구독 기간 종료 최소 24시간 전에 취소하지 않으면 자동으로 갱신됩니다.",
    ...
    sub_retry: "다시 시도",
    sub_disclosure: "구매 확인 시 Apple ID 계정으로 결제됩니다. 현재 구독 기간 종료 최소 24시간 전에 취소하지 않으면 구독이 자동으로 갱신됩니다. 현재 기간 종료 전 24시간 이내에 동일한 금액으로 갱신 비용이 계정에 청구됩니다. 구매 후 App Store 계정 설정에서 구독을 관리하고 취소할 수 있습니다.",
    ...
    // Review / Mistake Note
    review_title: "오답 노트",
    review_empty_title: "모두 완료! ✅",
    review_empty_desc: "저장된 복습 문제가 없어요. 정답 화면에서 ⭐를 탭하면 여기에 저장됩니다.",
    ...
    subs_errorMessage: "결제를 처리하지 못했습니다. 다른 카드를 사용하거나 결제 정보를 확인해 주세요.",
