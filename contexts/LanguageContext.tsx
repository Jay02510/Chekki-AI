...
const translations = {
  en: {
    ...
    sub_trial_subtext:
      'Full premium access. Cancel anytime before your trial ends and pay nothing.',
    ...
    diff_ocr_desc:
      "Don't waste time hunting for keys. Chekki identifies the questions and shows you exactly what to write, right on the screen.",
    diff_script: 'Bilingual Teaching Scripts',
    diff_script_desc:
      'We give you the exact words to say in Korean and English to encourage your child through the tricky parts.',
    ...
    zero_memory_desc:
      "We keep zero records of your scans or child's data. This ensures 100% privacy for schools and children. You are free to screenshot and save images directly to your device.",
  ...
  ko: {
    ...
    sub_trial_subtext:
      '프리미엄 전체 기능 이용. 체험 기간 종료 전 언제든지 취소하면 요금이 청구되지 않습니다.',
    ...
    diff_ocr_desc:
      '답지를 찾을 필요가 없어요. 채키가 문제를 읽고 정답을 정확한 위치에 표시해 드립니다.',
    diff_script: '다정한 티칭 스크립트',
    diff_script_desc:
      '영어를 몰라도 괜찮아요. 아이에게 어떻게 설명하면 좋을지 한국어와 영어 대본을 모두 드립니다.',
    diff_brand: '학원과의 연결',
    ...
    zero_memory_desc:
      '스캔 정보나 자녀 데이터를 일절 저장하지 않습니다. 이는 학교와 아이들의 개인정보를 완벽하게 보호하기 위함입니다. 필요한 경우 자유롭게 스크린샷을 찍어 기기에 저장하실 수 있습니다.',
