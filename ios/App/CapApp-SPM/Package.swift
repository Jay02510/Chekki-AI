...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "Chuseok22CapacitorKakaoLogin", path: "../../../node_modules/@chuseok22/capacitor-kakao-login"),
    ...
    targets: [
        .target(
            ...
            dependencies: [
                ...
                .product(name: "Chuseok22CapacitorKakaoLogin", package: "Chuseok22CapacitorKakaoLogin"),
