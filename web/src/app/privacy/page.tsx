        ...
        <section className="space-y-8">
          <div className="bg-white/5 p-8 rounded-2xl border border-white/10">
            ...
            <div className="text-white/70 leading-loose space-y-6">
              ...
              <p>
                <strong className="text-white block mb-2 text-lg">2. 이미지 처리 및 보안 (Zero-Storage Policy)</strong>
                <strong>업로드된 학습지 이미지는 분석을 위해서만 일시적으로 처리되며, 서버에 저장되지 않습니다.</strong> 분석이 완료되는 즉시 메모리에서 삭제됩니다.
              </p>
          ...
          <div className="bg-white/5 p-8 rounded-2xl border border-white/10">
            ...
            <div className="text-white/70 leading-loose space-y-6">
              ...
              <p>
                <strong className="text-white block mb-2 text-lg">2. Image Processing (Zero-Storage Policy)</strong>
                <strong>Uploaded worksheet images are processed temporarily for analysis and are NEVER stored on our servers.</strong> Images are purged immediately after processing.
              </p>
