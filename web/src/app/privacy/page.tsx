          ...
          <div className="bg-white/5 p-8 rounded-2xl border border-white/10">
            ...
            <div className="text-white/70 leading-loose space-y-6">
              ...
              <p>
                ...
                업로드된 원본 학습지 이미지와 추출된 텍스트 및 오답 데이터는 개인 맞춤형 복습 워크시트 생성 및 학습 진행도 추적을 위해 안전하게 서버에 저장됩니다.<br />
          ...
          <div className="bg-white/5 p-8 rounded-2xl border border-white/10">
            ...
            <div className="text-white/70 leading-loose space-y-6">
              ...
              <p>
                ...
                Uploaded original worksheet images, along with extracted text and mistake data, are stored securely on our servers to generate customized PDF practice worksheets and track learning progress.<br />
