...
export const ASSETS = {
  ...
  VIDEO_WALKTHROUGH: `https://res.cloudinary.com/dginphpy4/video/upload/f_auto,q_auto/Chekki_AI_V0_fkdlyx.mp4`,

  // MARKETING ASSETS (Updated with your IDs)
  // Thumbnails (PDF converted to JPG on the fly for UI display)
  FLYER_KR_THUMB: `https://res.cloudinary.com/dginphpy4/image/upload/w_600,h_800,c_fill,pg_1,f_auto,q_auto/Chekki_Korean_Flyer_v6lcjz.jpg`,
  FLYER_EN_THUMB: `https://res.cloudinary.com/dginphpy4/image/upload/w_600,h_800,c_fill,pg_1,f_auto,q_auto/Chekki_English_Flyer_dmhq8c.jpg`,
  
  // Shared PDF Links (Direct Public URLs for sharing)
  PDF_KR_SHARE: `https://res.cloudinary.com/dginphpy4/image/upload/Chekki_Korean_Flyer_v6lcjz.pdf`,
  PDF_EN_SHARE: `https://res.cloudinary.com/dginphpy4/image/upload/Chekki_English_Flyer_dmhq8c.pdf`,
  
  // Download Links (Triggers "Save As")
  PDF_KR_DOWNLOAD: `https://res.cloudinary.com/dginphpy4/image/upload/fl_attachment/Chekki_Korean_Flyer_v6lcjz.pdf`,
  PDF_EN_DOWNLOAD: `https://res.cloudinary.com/dginphpy4/image/upload/fl_attachment/Chekki_English_Flyer_dmhq8c.pdf`
};
