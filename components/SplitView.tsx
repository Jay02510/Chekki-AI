                ...
                <div key={item.id} ref={(el) => { itemRefs.current[item.id] = el; }} onClick={(e) => { e.stopPropagation(); setActiveItemId(item.id); }}
                  ...
                  <div className="flex items-start p-4 gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-2"><span className="font-hand text-xl text-emerald-400 font-bold">{cleanAnswer}</span></div>
                    </div>
                    <div className="flex items-center gap-1 shrink-0">
                      ...
                      <button onClick={(e) => { e.stopPropagation(); playAudio(cleanAnswer); }} className="p-2 rounded-full text-zinc-500 hover:text-white hover:bg-white/10 transition-colors">
