...
export const CameraView: React.FC<Props> = ({ onImageSelected }) => {
  ...
  const DropZone = ({ size = "large" }: { size?: "large" | "compact" }) => (
    <div className={`relative w-full ${size === 'large' ? 'min-h-[400px] h-auto' : 'h-[500px]'} perspective-1000 transition-all duration-700 ease-out py-8`}>
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[90%] h-[90%] border border-white/5 rounded-full animate-[spin_20s_linear_infinite] pointer-events-none"></div>
      <div 
        className={`relative w-full h-full max-w-2xl mx-auto bg-zinc-900/60 backdrop-blur-2xl rounded-[2.5rem] border transition-all duration-500 flex flex-col items-center justify-center p-10 group cursor-pointer overflow-hidden
      ...
      >
          ...
          <div className="relative z-10 flex flex-col items-center text-center">
            ...
            <div className="mt-8 flex flex-col items-center gap-3 group/btn">
                <div className="w-14 h-14 rounded-full bg-zinc-800 border-2 border-white/10 flex items-center justify-center shadow-lg group-hover/btn:bg-brand-orange group-hover/btn:border-white group-hover/btn:scale-110 transition-all duration-300">
    ...
    <div className="min-h-screen flex flex-col pt-32 md:pt-40 pb-20 overflow-x-hidden scroll-smooth">
      ...
      <div className="relative max-w-7xl mx-auto px-6 grid lg:grid-cols-[1.1fr_0.9fr] gap-12 lg:gap-8 items-center mb-32">
        ...
        <div className="w-full flex flex-col items-start text-left z-10 animate-fade-in-up order-2 lg:order-1">
          ...
          <p className="text-lg md:text-xl text-zinc-400 max-w-lg leading-relaxed mb-10 font-korean text-left font-medium break-keep">{t('hero_desc')}</p>
        ...
        <div className="w-full flex justify-center lg:justify-end items-center animate-fade-in-up order-1 lg:order-2">
            <div className="relative w-full max-w-[500px] aspect-square flex items-center justify-center">
                ...
                <img src={ASSETS.HERO_IMAGE} alt="Chekki Hero" className="w-full h-full object-contain drop-shadow-2xl animate-float relative z-10 scale-100 lg:scale-110"/>
            </div>
        </div>
      </div>
      ...
      <div className="bg-white/[0.02] border-y border-white/5 backdrop-blur-sm py-20 mb-32 relative overflow-hidden">
         <div className="max-w-7xl mx-auto px-6 text-center">
            <h2 className="text-xs font-black text-orange-500 uppercase tracking-[0.2em] mb-3 leading-tight">{t('how_title')}</h2>
          ...
          <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="bg-gradient-to-br from-zinc-900 to-zinc-950 p-10 rounded-[3rem] border border-white/5 shadow-2xl flex flex-col justify-center relative overflow-hidden group min-h-[400px]">
                  ...
                  <div className="relative z-10 drop-shadow-md">
                    <span className="text-orange-500 font-black text-xs uppercase tracking-widest mb-4">Vision AI</span>
              ...
              <div className="grid gap-8">
                  <div className="bg-zinc-900/50 p-8 rounded-[2.5rem] border border-white/5 backdrop-blur-sm flex items-start gap-6">
                      <div className="w-14 h-14 bg-emerald-500/10 rounded-2xl flex items-center justify-center text-2xl shrink-0">🔊</div>
                      <div>
                  ...
                  <div className="bg-zinc-900/50 p-8 rounded-[2.5rem] border border-white/5 backdrop-blur-sm flex items-start gap-6">
                      <div className="w-14 h-14 bg-purple-500/10 rounded-2xl flex items-center justify-center text-2xl shrink-0">📝</div>
                      <div>
                  ...
                  <div className="bg-zinc-900/50 p-8 rounded-[2.5rem] border border-white/5 backdrop-blur-sm flex items-start gap-6">
                      <div className="w-14 h-14 bg-pink-500/10 rounded-2xl flex items-center justify-center text-2xl shrink-0">🛡️</div>
                      <div>
      ...
      <div className="max-w-7xl mx-auto px-6 mb-40 text-center">
          <h2 className="text-xs font-black text-orange-500 uppercase tracking-[0.2em] mb-3 leading-tight">{t('test_title')}</h2>
      ...
      <div className="max-w-5xl mx-auto px-6 mb-20">
          <div className="bg-gradient-to-r from-orange-500 to-pink-500 rounded-[2.5rem] p-8 md:p-10 relative overflow-hidden shadow-2xl shadow-orange-500/20 group min-h-[350px] flex items-center">
              ...
              <div className="relative z-10 grid lg:grid-cols-[1.3fr_0.7fr] gap-8 items-center w-full">
                <div className="text-left animate-fade-in-up">
                  ...
                  <button onClick={openLoginModal} className="bg-white text-orange-600 px-10 py-4 rounded-xl font-black text-lg hover:bg-zinc-100 transition-all transform active:scale-95 shadow-2xl leading-tight">
                      {t('hero_cta_btn')}
                  </button>
                </div>
                ...
                <div className="hidden lg:flex justify-end items-center relative h-full">
                   <img 
                    ...
                    alt="Chekki Mascot" 
                    className="w-[110%] h-[110%] object-contain filter brightness-110 drop-shadow-[0_15px_40px_rgba(0,0,0,0.3)] animate-float" 
                   />
                </div>
              </div>
          </div>
      ...
      <footer className="max-w-7xl mx-auto px-6 pt-10 pb-10 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="flex flex-col items-center md:items-start gap-1">
              <div className="text-sm font-black text-white font-display leading-tight">Chekki<span className="text-orange-500">AI</span></div>
