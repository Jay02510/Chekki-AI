...
export const CameraView: React.FC<Props> = ({ onImageSelected }) => {
  ...
  const DropZone = ({ size = "large" }: { size?: "large" | "compact" }) => (
    <div 
      className={`relative w-full ${size === 'large' ? 'h-[500px]' : 'h-[550px]'} perspective-1000 transition-all duration-700 ease-out`}
    >
      {/* Decorative Rings */}
      ...
      <div 
        className={`absolute inset-4 md:inset-6 bg-[#0F1014]/80 backdrop-blur-2xl rounded-3xl border transition-all duration-500 flex flex-col items-center justify-center p-8 group cursor-pointer overflow-hidden
          ${dragActive 
            ? 'border-brand-orange shadow-[0_0_50px_rgba(249,115,22,0.3)] scale-[1.02]' 
            : 'border-white/10 shadow-2xl hover:border-white/30 hover:shadow-brand-orange/10 hover:-translate-y-1'
          }`}
      ...
      >
          ...
          <div className="relative z-10 flex flex-col items-center text-center">
            ...
            <p className="text-zinc-500 font-medium font-korean text-xl">
              {t('drop_subtitle')}
            </p>

            {/* Prominent Camera Action Button */}
            <div className="mt-8 flex flex-col items-center gap-3 group/btn">
                ...
                <span className="text-sm font-bold text-zinc-400 uppercase tracking-widest group-hover/btn:text-white transition-colors">
                    Upload Image
                </span>
            </div>
          </div>
    ...
    return (
      <div className="min-h-screen pt-32 pb-12 px-6 max-w-7xl mx-auto flex flex-col items-center animate-fade-in relative">
        ...
        <div className="w-full max-w-3xl flex flex-col items-center text-center mb-10 gap-6">
           ...
           <div className="bg-[#0F1014] border border-white/10 rounded-full py-2 px-6 flex items-center gap-3 shadow-lg">
               ...
               <div className="font-bold text-white text-xl font-display">
                  {user.plan === 'pro' ? '∞' : (user.maxScans - user.scansUsed)}
               </div>
           </div>
        </div>

        {/* Focused Upload Area - Centered & Larger */}
        <div className="w-full max-w-2xl animate-fade-in-up mb-12" style={{ animationDelay: '0.1s' }}>
           <DropZone size="large" />
        </div>

        <p className="mt-8 text-zinc-600 text-sm font-display text-center">
          {t('supported_formats')}
        </p>
        ...
        <div className="mt-12 text-center border-t border-white/5 pt-8 w-full max-w-lg mx-auto">
            ...
            <a href="mailto:chekkihelp@gmail.com" className="text-zinc-400 text-sm font-bold hover:text-white hover:underline transition-colors">
                Contact Us: chekkihelp@gmail.com
            </a>
        </div>
  ...
  return (
    <div className="min-h-screen flex flex-col pt-32 md:pt-40 pb-12 overflow-x-hidden scroll-smooth">
      ...
      {/* --- HERO SECTION --- */}
      <div className="relative max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-12 lg:gap-8 items-center mb-16 lg:mb-24">
        ...
        {/* Left Column: Text Content (Forced Left Align) */}
        <div className="w-full flex flex-col items-start text-left z-10 animate-fade-in-up order-2 lg:order-1">
          ...
          <h1 className="text-6xl md:text-8xl lg:text-[7rem] font-bold text-white font-display leading-[0.9] mb-8 tracking-tighter text-left drop-shadow-xl">
            Elevate Your <br/>
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 via-pink-500 to-purple-500 pb-2">Child's Learning.</span>
          </h1>
          
          <p className="text-xl md:text-2xl text-zinc-400 max-w-lg leading-relaxed mb-10 font-korean text-left font-medium">
            {t('hero_desc')}
          </p>
          ...
          <div className="flex flex-wrap gap-4 justify-start">
            <button 
              ...
              className="group relative bg-white text-black px-10 py-5 rounded-full font-bold text-xl transition-all transform hover:-translate-y-1 shadow-[0_0_20px_rgba(255,255,255,0.3)] hover:shadow-[0_0_30px_rgba(255,255,255,0.5)] font-display flex items-center gap-3 overflow-hidden"
            >
        ...
        {/* Right Column: Large Mascot Visual */}
        <div className="w-full flex justify-center lg:justify-end items-center animate-fade-in-up order-1 lg:order-2" style={{ animationDelay: '0.2s' }}>
          <div className="relative w-full max-w-[500px] aspect-square">
             <div className="absolute inset-0 bg-gradient-to-tr from-brand-orange/20 to-brand-purple/20 rounded-full blur-3xl animate-pulse-glow"></div>
             <div className="relative w-full h-full animate-float flex items-center justify-center">
                {!imgError ? (
                    <img 
                      src={ASSETS.HERO_IMAGE} 
                      alt="Chekki Future"
                      className="w-full h-full object-contain drop-shadow-[0_20px_50px_rgba(0,0,0,0.5)] scale-110 md:scale-125"
                      onError={() => setImgError(true)}
                    />
                ) : (
             ...
             <div className="absolute top-10 -right-4 md:top-20 md:-right-12 bg-zinc-900/80 backdrop-blur-xl border border-white/10 p-4 rounded-2xl shadow-2xl animate-[bounceSubtle_4s_infinite] flex items-center gap-4 z-20">
                <span className="text-3xl bg-white/5 rounded-xl p-2 border border-white/5">💯</span>
                <div className="flex flex-col text-left">
                   <span className="text-[10px] text-zinc-400 font-bold uppercase tracking-wider">Result</span>
                   <span className="text-lg font-bold text-white">Perfect Score!</span>
                </div>
             </div>
             
             <div className="absolute bottom-10 -left-4 md:bottom-20 md:-left-12 bg-zinc-900/80 backdrop-blur-xl border border-white/10 p-4 rounded-2xl shadow-2xl animate-[bounceSubtle_5s_infinite] flex items-center gap-4 z-20" style={{animationDelay: '1s'}}>
                <span className="text-3xl bg-white/5 rounded-xl p-2 border border-white/5">🗣️</span>
                <div className="flex flex-col text-left">
                   <span className="text-[10px] text-zinc-400 font-bold uppercase tracking-wider">Pronunciation</span>
      ...
      <div className="max-w-7xl mx-auto px-6 py-12 relative z-10">
        <div className="flex flex-col items-start mb-16 animate-fade-in-up" style={{animationDelay: '0.3s'}}>
           <div className="max-w-3xl text-left">
             <h2 className="text-5xl md:text-6xl font-bold font-display text-white mb-6 leading-tight text-left">
               Why Choose <br/>
               <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-purple to-brand-pink">Chekki AI?</span>
             </h2>
             <p className="text-zinc-400 text-xl font-korean text-left leading-relaxed">
               {t('hero_desc')}
             </p>
           </div>
        </div>

        {/* Bento Grid - Updated for 4 Items */}
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 auto-rows-[minmax(300px,auto)] animate-fade-in-up" style={{animationDelay: '0.4s'}}>
          ...
          {/* Card 1: 01 True Vision (Top Left - Large) */}
          <div className="md:col-span-7 bg-[#0F1014] border border-white/10 rounded-3xl p-8 relative overflow-hidden group hover:border-brand-pink/50 transition-all duration-500 flex flex-col justify-between hover:shadow-[0_0_30px_rgba(236,72,153,0.1)]">
             ...
             <div className="text-left relative z-10">
               ...
               <p className="text-zinc-400 text-base leading-relaxed font-korean">
                 {t('feat_vision_desc')}
               </p>
             </div>
          ...
          {/* Card 2: 02 Pronunciation (Top Right) */}
          <div className="md:col-span-5 bg-[#0F1014] border border-white/10 rounded-3xl p-8 relative overflow-hidden group hover:border-brand-purple/50 transition-all duration-500 flex flex-col justify-between hover:shadow-[0_0_30px_rgba(139,92,246,0.1)]">
             ...
             <div className="text-left relative z-10">
               ...
               <p className="text-zinc-400 text-base font-korean leading-relaxed">
                 {t('feat_audio_desc')}
               </p>
             </div>
          ...
          {/* Card 3: 03 Mistake Review (Bottom Left) */}
          <div className="md:col-span-5 bg-[#0F1014] border border-white/10 rounded-3xl p-8 relative overflow-hidden group hover:border-brand-orange/50 transition-all duration-500 hover:shadow-[0_0_30px_rgba(249,115,22,0.1)] flex flex-col justify-between">
             ...
             <div className="text-left relative z-10">
                ...
                <p className="text-zinc-400 text-base font-korean mb-6 leading-relaxed">
                  {t('feat_review_desc')}
                </p>
             </div>
             <div className="flex items-center gap-4 mt-auto">
               <div className="h-3 w-full bg-zinc-800 rounded-full overflow-hidden border border-white/5">
                 <div className="h-full bg-gradient-to-r from-brand-orange to-red-500 w-3/4 group-hover:w-[85%] transition-all duration-1000"></div>
               </div>
               <span className="text-sm text-brand-orange font-bold whitespace-nowrap">{t('growing_text')}</span>
             </div>
          </div>

          {/* Card 4: 04 Privacy First (Bottom Right - NEW) */}
          <div className="md:col-span-7 bg-[#0F1014] border border-white/10 rounded-3xl p-8 relative overflow-hidden group hover:border-emerald-500/50 transition-all duration-500 flex flex-col justify-between hover:shadow-[0_0_30px_rgba(16,185,129,0.1)]">
             ...
             <div className="text-left relative z-10 flex flex-col h-full">
               ...
               <p className="text-zinc-400 text-base leading-relaxed font-korean mb-8">
                 {t('feat_privacy_desc')}
               </p>
               ...
               <div className="mt-auto bg-zinc-900/50 border border-zinc-800 rounded-xl p-4 flex items-center gap-4 backdrop-blur-sm">
                    ...
                    <div className="h-px flex-1 bg-zinc-700/50 relative">
                        <div className="absolute inset-0 bg-gradient-to-r from-transparent via-zinc-500 to-transparent w-1/2 animate-[shimmer_2s_infinite]"></div>
                    </div>
      ...
      <div className="relative w-full py-32 bg-zinc-950 border-t border-white/5 overflow-hidden">
         ...
         {/* Background Orbs */}
         <div className="absolute top-1/2 left-10 w-96 h-96 bg-brand-orange/5 rounded-full blur-[100px] pointer-events-none"></div>
         <div className="absolute bottom-0 right-10 w-96 h-96 bg-brand-purple/5 rounded-full blur-[100px] pointer-events-none"></div>

         <div className="max-w-4xl mx-auto px-6 relative z-10 text-left animate-fade-in-up" style={{animationDelay: '0.5s'}}>
            <div className="mb-10 flex flex-col items-start w-full">
              <h2 className="text-4xl md:text-7xl font-bold text-white font-display mb-6 text-left tracking-tight">
                 {t('hero_cta_title')}
              </h2>
              <p className="text-zinc-400 font-korean text-xl mb-10 max-w-lg leading-relaxed text-left">
                 {t('hero_cta_desc')}
              </p>
              
              <button 
                onClick={openLoginModal}
                className="bg-orange-500 hover:bg-orange-600 text-white px-12 py-5 rounded-full font-bold text-xl shadow-xl shadow-orange-500/20 transition-all transform hover:scale-105"
              >
                {t('hero_cta_btn')}
              </button>
            </div>
      ...
      <div className="border-t border-white/5 bg-white/[0.02] backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-6 py-12 md:py-20 grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12">
            <div className="flex flex-col items-start justify-center space-y-2 group cursor-default">
              <div className="text-5xl md:text-6xl font-bold text-white font-display group-hover:scale-110 transition-transform duration-300">
                98<span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-500 to-pink-500">%</span>
              </div>
            ...
            <div className="flex flex-col items-start justify-center space-y-2 group cursor-default">
              <div className="text-5xl md:text-6xl font-bold text-white font-display group-hover:scale-110 transition-transform duration-300">
                10<span className="text-brand-purple">k+</span>
              </div>
            ...
            <div className="flex flex-col items-start justify-center space-y-2 group cursor-default">
              <div className="text-5xl md:text-6xl font-bold text-white font-display group-hover:scale-110 transition-transform duration-300">
                500<span className="text-brand-pink">k+</span>
              </div>
      ...
      <div className="text-center mt-12 mb-8 flex flex-col gap-4">
        ...
        <div className="text-zinc-600 text-xs">
            Questions? <a href="mailto:chekkihelp@gmail.com" className="text-zinc-500 hover:text-white underline ml-1">chekkihelp@gmail.com</a>
        </div>
      </div>
