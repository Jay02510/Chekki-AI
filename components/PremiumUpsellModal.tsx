    ...
    <div className="fixed inset-0 z-[100] flex items-end md:items-center justify-center p-0 md:p-4">
      ...
      >
        ...
        <div className="p-4 flex items-center">
          <button
            onClick={onClose}
            className={`flex items-center gap-2 ${isNight ? 'text-zinc-400 hover:text-white' : 'text-zinc-500 hover:text-zinc-900'} transition-colors text-sm font-bold active:scale-95`}
          >
