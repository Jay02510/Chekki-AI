...
export const ScreenshotCarousel: React.FC = () => {
    ...
    return (
        ...
        >
            <div className="relative aspect-[9/16] md:aspect-video w-full overflow-hidden rounded-[2rem] md:rounded-[3rem] bg-zinc-900/50 border border-white/10 shadow-2xl">
                {/* Images */}
                <div
                ...
                >
                    <span className="text-xl md:text-3xl group-hover:-translate-x-1 transition-transform">←</span>
                </button>
                <button
