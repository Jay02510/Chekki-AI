...
export const LegalModal: React.FC<Props> = ({
  ...
  const getHeader = () => {
    switch (type) {
      case 'privacy':
        return { title: '개인정보처리방침 / Privacy Policy', icon: '🔒' };
      case 'terms':
        return { title: '이용약관 / Terms of Service', icon: '📜' };
      case 'refund':
        return { title: '환불 정책 / Refund Policy', icon: '💳' };
      case 'youth':
        return { title: '청소년 보호 정책 / Youth Protection', icon: '🛡️' };
      case 'support':
        return { title: '고객 지원 / Customer Support', icon: '💬' };
      default:
        return { title: 'Legal', icon: '⚖️' };
    }
  };
      ...
      >
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2
                className={`text-sm md:text-base font-bold ${isNight ? 'text-white' : 'text-zinc-900'} font-display`}
              >
                {title}
              </h2>
              <p
                className={`text-[10px] ${isNight ? 'text-zinc-500' : 'text-zinc-400'} uppercase tracking-widest`}
              >
                {date}
              </p>
            </div>
        ...
        <div
          className={`flex-1 overflow-y-auto custom-scrollbar p-6 space-y-8 ${isNight ? 'bg-zinc-900' : 'bg-white'}`}
        >
          {type === 'terms' && (
              ...
              <section className="space-y-4">
                ...
                >
                  ...
                  >
                    ...
                    <p>
                      본 약관은 Chekki (채키) (이하 “서비스”)가 제공하는 온라인 학습 보조 서비스의
                      이용 조건 및 절차, 이용자와 운영자 간의 권리와 의무를 규정함을 목적으로
                      합니다.
                    </p>
                    <p>
                    ...
                    <p>
                      ...
                      기간은 결제일로부터 30일입니다.
                      <br />
                      2. 구독 서비스는 이용자가 해지하기 전까지 매월 정기적으로 자동 결제가
                      진행됩니다.
                    </p>
                    <p>
                      ...
                      요청할 수 있습니다.
                      <br />
                      2. 서비스 해지(자동 결제 중단)는 설정 메뉴 내 &apos;구독 관리&apos;를 통해
                      언제든지 가능하며, 해지 시 다음 결제 예정일부터 과금이 중단됩니다.
                    </p>
                  </div>
                </div>
                <div
                ...
                >
                  ...
                  >
                    ...
                    <p>
                      These terms govern your use of the Chekki (&quot;Service&quot;) online
                    ...
                    <p>
                      ...
                      <br />
                      2. Subscriptions renew automatically every 30 days unless cancelled by the
                      user.
                    </p>
                    <p>
                      ...
                      has not been used.
                      <br />
                      2. Subscription cancellation can be performed at any time through the
                      &quot;Settings&quot; menu. Cancellation prevents future recurring charges.
                    </p>
                  </div>
                </div>
              </section>
                ...
                <div className={`${isNight ? 'bg-zinc-800/60 border-zinc-700/60' : 'bg-zinc-50 border-zinc-200 shadow-sm'} p-5 md:p-6 rounded-xl border`}>
                  ...
                  <div className={`${isNight ? 'text-zinc-200' : 'text-zinc-800'} text-xs md:text-sm leading-relaxed space-y-4 font-normal`}>
                    <p>
                      ...
                      <br />
                      - 수집 항목: 이름, 이메일 주소, 기기 정보
                      <br />- 수집 목적: 회원 식별, 서비스 알림, 기능 개선
                    </p>
                    ...
                    <p>
                      ...
                      관리됩니다.
                      <br />
                      - 인프라: Firebase (Google Cloud)
                      <br />- AI 분석: Google Gemini API
                    </p>
                ...
                <div className={`${isNight ? 'bg-zinc-800/60 border-zinc-700/60' : 'bg-zinc-50 border-zinc-200 shadow-sm'} p-5 md:p-6 rounded-xl border`}>
                  ...
                  <div className={`${isNight ? 'text-zinc-200' : 'text-zinc-800'} text-xs md:text-sm leading-relaxed space-y-4 font-normal`}>
                    <p>
                      ...
                      delivery.
                      <br />
                      - Items: Name, email address, device info.
                      <br />- Purpose: User identification, service notifications, and feature
                      improvements.
                    </p>
                ...
                <div className={`${isNight ? 'bg-zinc-800/60 border-zinc-700/60' : 'bg-zinc-50 border-zinc-200 shadow-sm'} p-5 md:p-6 rounded-xl border`}>
                  ...
                  <div className={`${isNight ? 'text-zinc-200' : 'text-zinc-800'} text-xs md:text-sm leading-relaxed space-y-4 font-normal`}>
                    <p>
                      ...
                      been accessed.
                      <br />- Refunds may be restricted for used digital content once analysis or
                      pro features have been accessed.
                    </p>
              ...
              <section className="space-y-4">
                <div className={`${isNight ? 'bg-zinc-800/60 border-zinc-700/60' : 'bg-zinc-50 border-zinc-200 shadow-sm'} p-5 md:p-6 rounded-xl border`}>
                  ...
                  <div className={`${isNight ? 'text-zinc-200' : 'text-zinc-800'} text-xs md:text-sm leading-relaxed space-y-4 font-normal`}>
                    ...
                    <p>
                      이미지 분석 오류나 결제 관련 문의는 스크린샷과 함께 이메일로 보내주시면 더욱
                      신속하게 도와드릴 수 있습니다.
                    </p>
                  </div>
                </div>
                <div className={`${isNight ? 'bg-zinc-800/60 border-zinc-700/60' : 'bg-zinc-50 border-zinc-200 shadow-sm'} p-5 md:p-6 rounded-xl border`}>
                  ...
                  <div className={`${isNight ? 'text-zinc-200' : 'text-zinc-800'} text-xs md:text-sm leading-relaxed space-y-4 font-normal`}>
                    ...
                    <p>
                      For issues regarding image analysis or payments, please include a screenshot
                      and your account email for faster resolution.
                    </p>
                  </div>
                </div>
              </section>
