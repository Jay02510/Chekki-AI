      ...
      >
        ...
        <div className="bg-white p-6 border-t border-gray-200 flex justify-end gap-3 shrink-0 z-10">
          ...
          {!isDigitalMode && (
            <button
              onClick={handlePrint}
              className="px-10 py-3 rounded-xl font-bold bg-zinc-900 text-white shadow-xl flex items-center gap-2 transform transition-all active:scale-95 min-h-[48px]"
            >
