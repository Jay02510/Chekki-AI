...
export const BillingModal: React.FC<Props> = ({ onClose, isNight = true }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <div
        className={`relative ${isNight ? 'bg-zinc-900 border-white/5' : 'bg-white border-zinc-200 shadow-2xl'} rounded-3xl w-full max-w-2xl md:max-w-3xl border overflow-hidden animate-fade-in-up max-h-[90vh] flex flex-col`}
      >
        <div
