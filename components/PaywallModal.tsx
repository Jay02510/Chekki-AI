        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-3 md:p-4">
            ...
            <div className="relative bg-zinc-900 rounded-[2rem] md:rounded-[2.5rem] w-full max-w-4xl overflow-hidden shadow-[0_0_100px_rgba(249,115,22,0.2)] border border-white/10 animate-fade-in-up flex flex-col max-h-[92vh]">
                ...
                <div className="flex-1 overflow-y-auto w-full pb-6 custom-scrollbar">
                    ...
                    {showCodeInput && (
                        <div className="px-6 md:px-10 pb-10 pt-4 flex flex-col items-center flex-1 justify-center max-w-2xl mx-auto w-full">
                    ...
                    <div className="mt-8 mb-4 flex flex-col items-center gap-4 w-full">
