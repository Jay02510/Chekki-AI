...
// Fix: Simplified ErrorBoundary to use property initializers for state and rely on React.Component's built-in props definition
...
function AppContent() {
  ...
  // Standalone Legal Route Detection
  useEffect(() => {
