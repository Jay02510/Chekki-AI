      ...
      <div className="fixed top-6 left-0 w-full z-50 flex justify-center px-4">
        <header className="flex h-14 items-center justify-between px-6 max-w-4xl w-full mx-auto bg-white/5 backdrop-blur-2xl border border-white/10 rounded-full shadow-2xl">
          ...
          <nav className="hidden md:flex items-center gap-8">
            <a href="/app" className="text-sm font-medium text-white/60 hover:text-white transition-colors outline-none focus-visible:ring-2 focus-visible:ring-brand focus-visible:ring-offset-2 focus-visible:ring-offset-[#050505] rounded-sm">Web App</a>
      ...
      {mobileMenuOpen && (
        <div className="fixed inset-0 z-40 bg-black/80 backdrop-blur-3xl flex flex-col items-center justify-center">
          <nav className="flex flex-col items-center gap-8 text-2xl font-medium text-white">
            <a href="/app" onClick={() => setMobileMenuOpen(false)} className="hover:text-brand transition-colors outline-none focus-visible:ring-2 focus-visible:ring-brand rounded-sm">Web App</a>
      ...
      <section id="main-content" ref={heroRef} className="relative pt-40 pb-32 md:pb-48 px-4 md:px-8 max-w-7xl mx-auto w-full flex flex-col md:flex-row items-center justify-between gap-12 md:gap-8 min-h-[100dvh]">
        <div className="flex-1 flex flex-col items-start z-10 w-full">
          ...
          <div className="hero-text mt-12 flex flex-col sm:flex-row items-center gap-6 w-full sm:w-auto">
            ...
            <a href="/app" className="group relative w-full sm:w-auto overflow-hidden pl-8 pr-2 py-2 bg-brand text-white font-bold rounded-full text-lg flex items-center justify-between gap-8 transition-transform duration-700 ease-[var(--ease-premium)] active:scale-[0.98] shadow-2xl shadow-brand/20 outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-[#050505]">
      ...
      <footer className="py-32 md:py-48 px-4 md:px-8 bg-[#020617] border-t border-white/5 flex flex-col items-center justify-center text-center relative overflow-hidden">
        ...
        <div className="relative z-10 mt-24 flex flex-col items-center gap-6">
          <div className="flex items-center gap-6 text-white/50 text-sm font-medium mb-4">
            <a href="#" className="hover:text-white transition-colors outline-none focus-visible:ring-2 focus-visible:ring-white rounded-sm">Privacy Policy</a>
            <a href="#" className="hover:text-white transition-colors outline-none focus-visible:ring-2 focus-visible:ring-white rounded-sm">Terms of Service</a>
          </div>
