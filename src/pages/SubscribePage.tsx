    ...
    return (
        <div className="min-h-screen bg-[#050505] text-white flex flex-col items-center justify-center px-6 py-16 relative overflow-hidden">
            ...
            <div className="text-center mb-10">
                ...
                <p className="text-zinc-500 text-xs font-black uppercase tracking-[0.3em] mt-2">Homework Helper</p>
            </div>

            {/* Main card */}
            <div className="bg-zinc-900 border border-white/10 rounded-[2.5rem] max-w-lg w-full p-8 md:p-12 text-center shadow-[0_0_80px_rgba(249,115,22,0.1)] relative">
