...
- **Standard Response (Korean):**
  > "전혀 걱정하지 않으셔도 됩니다. 채키는 아이가 휴대폰 화면을 계속 들여다보게 만드는 멀티미디어 앱이 아닙니다. 아이는 종이 워크북과 연필로 직접 문제를 풀고, 부모님이 1~2초간 카메라로 비춰 정답과 [엄마 스크립트]를 확인하는 용도로 사용됩니다. 스크린 타임을 최소화하고 실제 종이 학습과 부모님과의 대화를 촉진하도록 설계되었습니다."
- **Key Talking Points:**
  - Micro-burst screen usage (10-15 seconds per page).
  - The child stays focused on their physical paper workbook and pencil.
  - The phone is held by the parent as a teaching assistant.
...
- **Standard Response (Korean):**
  > "네, 100% 북미 표준 원어민(Standard American English) 발음 프로필을 기반으로 작동합니다. 파닉스 단어 음소 하나하나부터 문장 전체 억양까지, 아이들이 폴리나 GATE 같은 영유에서 배우는 북미 원어민 교사의 발음과 동일한 사운드로 익힐 수 있습니다."
- **Key Talking Points:**
  - Standard North American accent profiles (TTS).
  - Voice recognition (STT) calibrated for children's speech pitch and cadence.
  - Interactive speech feedback rewards clear native-like pronunciation with dopamine badges.
...
- **Key Talking Points:**
  - 100% ad-free, secure environment.
  - Intuitive, tactile UI designed for young children.
  - Designed primarily for parent-child bonding rather than solitary screen placement.
...
- **Standard Response (Korean):**
  > "채키는 고정된 양식만 인식하는 기존 앱과 다릅니다. 구글의 최신 Gemini 2.5 멀티모달 AI가 탑재되어 있어, 폴리(Poly), GATE, PSA, ECC 등 어떤 유치원이나 학원의 독자적인 워크시트라도 촬영 즉시 지문 구조와 텍스트 레이아웃을 스스로 분석해 냅니다. 원어민 학원 교재부터 일반 시중 영어 학습지까지 완벽하게 지원합니다."
- **Key Talking Points:**
  - Dynamic AI layout detection (no rigid template matching).
  - Handles phonics grids, reading comprehension, grammar matching, and fill-in-the-blanks.
  - B2B Academy pre-seeding available for custom school word lists.
...
- **Standard Response (Korean):**
  > "월 몇 십만 원이 드는 과외나 학원 추가 수업에 비해, 채키 프로(Pro)는 하루 단 몇 백 원 수준으로 매일 저녁 전담 원어민 튜터와 한국어 지도 교사를 집에 모시는 것과 같은 효과를 제공합니다. 매일 3회 무료 스캔도 제공되니 부담 없이 먼저 체험해 보세요."
- **Key Talking Points:**
  - Free Explorer tier available (3 daily scans).
  - Pro tier offers unlimited scans (9,999/day) for a fraction of private tutor costs.
  - Instant access 24/7 without scheduling friction.
